---
title: "wayland-server: Display, Resource, GlobalDispatch Reference"
sidebarTitle: "wayland-server"
description: "API reference for wayland-server 0.31.x: Display, DisplayHandle, Resource trait, GlobalDispatch, Dispatch, Client, and ListeningSocket."
---
