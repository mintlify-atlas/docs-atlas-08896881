...
description: "Use wayland-scanner proc-macros to generate type-safe Rust client and server bindings from any Wayland XML protocol specification file at compile time."
---
