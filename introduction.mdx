...
description: "wayland-rs is a workspace of 12 Rust crates providing pure-Rust and system-backed bindings for the Wayland display protocol."
---
...
<CardGroup cols={2}>
  ...
  <Card title="wayland-cursor" icon="arrow-pointer" href="https://docs.rs/wayland-cursor">
    Loads XCursor images from the system cursor theme and uploads them into `WlBuffer`s. Handles the metadata required to display animated cursors correctly.
  </Card>
</CardGroup>
